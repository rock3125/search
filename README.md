...
![Screenshot 2](screenshots/search-screenshot-2.png)
...
|--------------------------------|--------------------------------------|------------------------------------------------------------------------|
| version                        | 8.4.0                                | Current version of SimSage displayed on UX                             |
...
| html_types                     | ["asp", "aspx", etc.]                | File extensions to render as HTML                                      |
| valid_types                    | ["adoc", "xls", "docx", etc.]        | Valid types for preview                                                |
| video_types                    | ["mp4", "webm"]                      | Video types                                                            |
| audio_types                    | ["mpeg", "wav"]                      | Audio types                                                            |
...
| show_llm_menu                  | false                                | Show LLM (AI) menu options                                             |
...
| llm_search                     | false                                | Enable LLM (AI) search capabilities                                    |
...
| customer                       | simsage                              | Branding, (logo display), one of [simsage, malaghan, hemubo, wcc, icc] |
| source_icons                   | {}                                   | Custom icons for sources, mapping source IDs to icon URLs              |
| date_options                   | {...struct}                          | time display format                                                    |
